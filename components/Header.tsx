...
const Header = () => {
  ...
  // getting user by email so I can get his user id and wishlist
  const getUserByEmail = React.useCallback(async () => {
    // Define getWishlistByUserId inside useCallback to avoid dependency issues
  ...
  }, [session?.user?.email, setWishlist]);
